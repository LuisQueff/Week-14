...
describe("Cases in which the purchase is successful", () => {
    ...
    it("should be able to buy a product", async () => {
        ...
        await expect(CompletePage.successText1).toHaveText("THANK YOU FOR YOUR ORDER");
        await expect(CompletePage.successText2).toHaveText("Your order has been dispatched, and will arrive just as fast as the pony can get there!");
        await expect(CompletePage.imgPony).toHaveAttr("src", "/static/media/pony-express.46394a5d.png");
